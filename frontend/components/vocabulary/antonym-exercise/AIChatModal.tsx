  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const chatRequest: ChatRequest = {
        ...
        example:
          lexiconData?.relations?.antonyms?.[0] || "No example available",
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b text-orange-950 rounded-t-2xl">
            ...
            <div className="p-4 border-t bg-gray-50 rounded-b-2xl">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-orange-950 border-2 border-orange-950/50 rounded-lg hover:border-orange-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
