...
interface ChooseSentenceCompletionModalProps {
  isOpen: boolean;
  score: number;
  correctCount: number;
...
export default function ChooseSentenceCompletionModal({
  isOpen,
  score,
  correctCount,
  totalQuestions,
  onClose,
  onRetake,
}: ChooseSentenceCompletionModalProps) {
                ...
                <div className="p-8 space-y-6 h-full flex flex-col">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      You've finished the choose sentence exercise.
                    </p>
                  </div>
